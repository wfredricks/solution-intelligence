...
- **GitHub Security Advisories:**
  <https://github.com/wfredricks/solution-intelligence/security/advisories/new>
...
load-bearing; it must be understood before solution-intelligence is adopted.

### What solution-intelligence protects against
...
### What solution-intelligence does NOT protect against
...
|                  Adopter application                 |
|  +------------------------------------------------+  |
|  |    solution-intelligence Ledger (in-process library)     |  |
|  |                                                |  |
